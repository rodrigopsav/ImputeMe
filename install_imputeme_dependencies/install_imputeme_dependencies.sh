...
#-----------------------------#
"
conda install -y -n imputeme -c conda-forge parallel 
...
#-----------------------------#
"
conda install -y -n imputeme -c trent dos2unix 
...
#-----------------------------#
"
conda install -y -n imputeme -c bioconda bedtools
...
#---------------------------#
"
conda install -y -n imputeme -c bioconda vcflib
...
#--------------------------#
"
conda install -y -n imputeme -c bioconda plink
conda install -y -n imputeme -c bioconda plink2
...
#--------------------------#
"
#conda install -y -n imputeme -c soil eagle-phase
...
#-----------------------------#
"
conda install -y -n imputeme -c bioconda shapeit4
...
#----------------------------#
"
conda install -y -n imputeme -c bioconda impute2
...
#---------------------------#
"
#conda install -y -n imputeme -c bioconda beagle
...
#------------------------------#
"
conda install -y -n imputeme -c bioconda admixture
...
#------------------------------#
"
conda install -y -n imputeme -c bioconda structure
...
#----------------------------#
#"
conda install -y -n imputeme -c anaconda openjdk
